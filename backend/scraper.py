...
def get_news_data(url):
    ...
    try:
        ...
        return {
            ...
            "company_name": soup.select_one(".media_end_head_top_logo img")["title"] if soup.select_one(".media_end_head_top_logo img") else "언론사 미상",
            "img_urls": img_urls,
            "url": url,
            "category": "미분류" # 기본값 설정
        }
    ...
    for sid in sections:
        ...
        try:
            ...
            for url in urls:
                ...
                exists_content = db_session.query(News).join(Company).filter(
