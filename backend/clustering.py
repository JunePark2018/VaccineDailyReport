...
collection = chroma_client.get_or_create_collection(
    name="news_articles_ko", metadata={"hnsw:space": "cosine"}
)
...
def simple_kg_check(articles):
    ...
    stopwords = {
        "오늘", "내일", "속보", "단독", "종합", "기자", "보도", "사진", "포토", "관련", 
        "어제", "진행", "개최", "출시", "등록", "확인", "발표", "예정", "위해", "의해", 
        "정치", "지난", "이번", "통해", "대한", "업계", "시장", "국내", "글로벌", "의료", "의료계",
        "뉴스", "기사", "소식", "정보", "현장", "특징", "정리", "무단", "배포", "금지", "전재",
        "기업", "업체", "동향", "현황", "사업", "추진", "기대", "전망", "성장", "강화", 
        "목표", "주목", "가속", "본격", "최근", "성공", "결과", "계획", "선정", "확대",
        "바이오", "제약사", "치료", "제품", "기술", "개발", "환자", "사용", "도움", 
        "기능", "효과", "시스템", "도입", "제공", "서비스", "운영", "관리", "인증", "수상", "지원"
    }
