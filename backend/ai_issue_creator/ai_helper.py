...
GOOGLE_API_KEY = "AIzaSyBpKyQgL52fWqZAMvU4hQ1PmBDlhnh7w_4".strip()
HF_TOKEN = "".strip()
    ...
    try:
        ...
        # ---------------------------------------------------------
            ...
            payload = {
                ...
                # 1. 생성 설정 (말더듬 방지)
                "generationConfig": {"temperature": 0.2, "maxOutputTokens": 4000, "topP": 0.8, "topK": 40},
