...
const PoliticsPage = () => {
    ...
    const renderAIRecommendedNews = (mainBaseIndex) => {
        ...
        // In category pages, renderMainContent is called in a loop for 5 pages, 
        // each showing 4 articles. Total articles shown = 20.
        // We'll pick articles with an offset from the total shown.
        const totalShown = 20;
